...
const d = new Date();let month = d.getMonth();let day = d.getDate();let hour = d.getHours();let mint = d.getMinutes();
...
no.addEventListener("click", ()=>{if(element !== "" && Array.from(element.classList).includes("true")==true){
element.innerHTML=""
...
let tableBody = document.querySelector("#tableBody")
 tableBody.innerHTML+= `<tr><td class="mo"></td><td class="mo"></td><td class="mo"></td><td class="mo"></td><td colspan="2" id="name">${newName}</td><td colspan="1" class="del">X</td></tr> `
 localStorage.setItem("TableBody", tableBody.innerHTML)
